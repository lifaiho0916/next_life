...
class MyLifeProfilePage extends StatefulWidget {
  const MyLifeProfilePage({
  ...
  @override
  State<MyLifeProfilePage> createState() => _MyLifeProfilePageState();
}

class _MyLifeProfilePageState extends State<MyLifeProfilePage> {
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(
                child: Text(
                  "You can also add to the MyLife of My NextLife Profiles",
