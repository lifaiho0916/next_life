...
class CertificationDialogNextLifePage extends StatefulWidget {
  const CertificationDialogNextLifePage({Key? key}) : super(key: key);

  @override
  State<CertificationDialogNextLifePage> createState() =>
      _CertificationDialogNextLifePageState();
}

class _CertificationDialogNextLifePageState extends State<CertificationDialogNextLifePage> {
