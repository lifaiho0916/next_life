...
class HighestLevelAchievedDialogNextLifePage extends StatefulWidget {
  const HighestLevelAchievedDialogNextLifePage({Key? key}) : super(key: key);

  @override
  State<HighestLevelAchievedDialogNextLifePage> createState() =>
      _HighestLevelAchievedDialogNextLifePageState();
}

class _HighestLevelAchievedDialogNextLifePageState
    extends State<HighestLevelAchievedDialogNextLifePage> {
  @override
