...
class MonthlyIncomeDialogNextLifePage extends StatefulWidget {
  const MonthlyIncomeDialogNextLifePage({Key? key}) : super(key: key);

  @override
  State<MonthlyIncomeDialogNextLifePage> createState() =>
      _MonthlyIncomeDialogNextLifePageState();
}

class _MonthlyIncomeDialogNextLifePageState extends State<MonthlyIncomeDialogNextLifePage> {
