...
class LivingSituationNextLifePage extends StatefulWidget {
  const LivingSituationNextLifePage({Key? key}) : super(key: key);

  @override
  State<LivingSituationNextLifePage> createState() => _LivingSituationNextLifePageState();
}

class _LivingSituationNextLifePageState extends State<LivingSituationNextLifePage> {
