...
class MonthlyExpenseDialogNextLifePage extends StatefulWidget {
  const MonthlyExpenseDialogNextLifePage({Key? key}) : super(key: key);

  @override
  State<MonthlyExpenseDialogNextLifePage> createState() =>
      _MonthlyExpenseDialogNextLifePageState();
}

class _MonthlyExpenseDialogNextLifePageState extends State<MonthlyExpenseDialogNextLifePage> {
