...
class GraduationDateDialogNextLifePage extends StatefulWidget {
  const GraduationDateDialogNextLifePage({Key? key}) : super(key: key);

  @override
  State<GraduationDateDialogNextLifePage> createState() =>
      _GraduationDateDialogNextLifePageState();
}

class _GraduationDateDialogNextLifePageState extends State<GraduationDateDialogNextLifePage> {
  @override
